  ...
  const addToCart = (menuItem: MenuItemType) => {
    setCartItems((prevCartItems)=> {
      ...
      if (existingCartItem) {
        ...
        // 3. if item is not in cart, add the item
        updatedCartItems = [
          ...prevCartItems, {
            _id: menuItem._id,
            name: menuItem.name,
  ...
  const minusQuantity = (cartItem: CartItem) => {
    setCartItems((prevCartItems)=> {
      ...
      if (cartItem.quantity - 1 === 0) {
        updatedCartItems = prevCartItems.filter(item => cartItem._id !== item._id);
      } else {
    ...
    <div className="flex flex-col gap-10">
      <AspectRatio ratio={16 / 5}>
        <img  
          ...
          src={restaurant.imageUrl} alt="restaurant image"
        />
      </AspectRatio>

      <div className="grid md:grid-cols-[4fr_3fr] gap-5 md:px-24">
